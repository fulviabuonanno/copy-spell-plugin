...
async function extractColors(node) {
    var _a;
    const colors = [];
    if ('fills' in node) {
        ...
        if (Array.isArray(fills)) {
            for (const fill of fills) {
                ...
                if (colorValue) {
                    ...
                    if ('boundVariables' in fill && ((_a = fill.boundVariables) === null || _a === void 0 ? void 0 : _a.color)) {
                        try {
...
async function getColorsFromSelection() {
